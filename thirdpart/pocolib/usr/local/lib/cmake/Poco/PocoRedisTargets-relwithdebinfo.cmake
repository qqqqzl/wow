...
set_target_properties(Poco::Redis PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoRedis.80.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoRedis.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::Redis )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::Redis "${_IMPORT_PREFIX}/lib/libPocoRedis.80.dylib" )
