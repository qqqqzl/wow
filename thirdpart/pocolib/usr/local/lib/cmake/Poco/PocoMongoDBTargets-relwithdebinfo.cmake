...
set_target_properties(Poco::MongoDB PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoMongoDB.80.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoMongoDB.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::MongoDB )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::MongoDB "${_IMPORT_PREFIX}/lib/libPocoMongoDB.80.dylib" )
