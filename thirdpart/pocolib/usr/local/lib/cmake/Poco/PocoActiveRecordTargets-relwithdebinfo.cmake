...
set_target_properties(Poco::ActiveRecord PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoActiveRecord.80.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoActiveRecord.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::ActiveRecord )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::ActiveRecord "${_IMPORT_PREFIX}/lib/libPocoActiveRecord.80.dylib" )
