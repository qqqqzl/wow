...
set_target_properties(Poco::XML PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoXML.80.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoXML.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::XML )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::XML "${_IMPORT_PREFIX}/lib/libPocoXML.80.dylib" )
