...
set_target_properties(Poco::Zip PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoZip.80.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoZip.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::Zip )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::Zip "${_IMPORT_PREFIX}/lib/libPocoZip.80.dylib" )
