...
set_target_properties(Poco::Util PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoUtil.80.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoUtil.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::Util )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::Util "${_IMPORT_PREFIX}/lib/libPocoUtil.80.dylib" )
