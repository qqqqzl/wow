...
set_target_properties(Poco::Net PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoNet.80.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoNet.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::Net )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::Net "${_IMPORT_PREFIX}/lib/libPocoNet.80.dylib" )
